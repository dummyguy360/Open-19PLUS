...
if (place_meeting(x, y, obj_player) && obj_player.state == 39 && image_index == 1 && !global.panic && obj_player.sprite_index != obj_player.spr_lookdoor && floor(obj_player.image_index) >= 14)
{
