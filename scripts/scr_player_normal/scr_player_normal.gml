function scr_player_normal()
{
    ...
    if ((character == "N" || sprite_index != spr_moveturn) && sprite_index != _fallanim && !landAnim && move != 0 && _walkframecheck && steppy == 0)
    {
    ...
    if ((character == "N" || sprite_index != spr_moveturn) && !landAnim && move != 0 && !_walkframecheck)
        steppy = 0;
}
