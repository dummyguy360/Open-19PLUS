function scr_player_Sjump()
{
    ...
    if (sprite_index == spr_superjump || sprite_index == spr_presentjump || sprite_index == spr_player_bombjump || sprite_index == spr_playerN_bombjump)
    {
        vsp = sjumpvsp;
    ...
    if (sprite_index == spr_player_bombjump || sprite_index == spr_playerN_bombjump)
    {
